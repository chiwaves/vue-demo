            ...
            <div class="swiper-box">
                <div class="site-category">
                    <ul class="categoryList">
                        ...
                        <li class="category-item">
                            <a href="javascript:;" class="item-name">笔记本 显示器 平板</a>
                            <div class="children">
                                <ul v-for="(item, i) in menuList" :key="i">
                                    <li v-for="(sub, j) in item" :key="j">
                                        <a href="javascript:;" @click="gotoProduct(sub)" target="_blank">
                        ...
                        <li class="category-item">
                            <a href="javascript:;" class="item-name">健康 儿童</a>
                            <div class="children">
                                <ul v-for="(item, i) in menuList" :key="i">
                                    <li v-for="(sub, j) in item" :key="j">
                                        <a href="javascript:;" @click="gotoProduct(sub)" target="_blank">
                        ...
                        <li class="category-item">
                            <a href="javascript:;" class="item-name">耳机 音箱</a>
                            <div class="children">
                                <ul v-for="(item, i) in menuList" :key="i">
                                    <li v-for="(sub, j) in item" :key="j">
                                        <a href="javascript:;" @click="gotoProduct(sub)" target="_blank">
        ...
        methods:{
            init(){
                this.axios.get('/products', {
                    ...
                    this.proList = res.list.slice(6, 14)
                })
            },
            gotoCart(){
            ...
            .site-category{
                ...
                .category-item{
                    ...
                    .item-name{
                        ...
                        &::after{
                            content:' ';
                            @include bgImg(10px, 14px, 'icon-arrow.png');
                            position: absolute;
                            right: 20px;
                            top: 14px;
                        }
